...
const Footer = () => {
  ...
  const services = [
    { name: "RAF Claims", path: "/services/road-accident-fund-claims" },
    { name: "Criminal Law", path: "/services/criminal-law" },
    { name: "Divorce & Family", path: "/services/divorce-family-law" },
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <div className="flex items-center space-x-2 mb-4">
              ...
              />
              <div className="font-legal font-bold text-xl">
                Y Tshika Attorneys Inc.
              </div>
            </div>
